<?php
/** A simple text block **/
class Portfolio2_Block extends AQ_Block {
	//set and create block
	function __construct() {
		$block_options = array(
			'name' => '<i class="fa fa-medkit"></i> Recent Works 2',
			'size' => 'col-md-12',
			'offset' => '',
			'effect' => 'None',
		);
		...
		//create the block
		parent::__construct('Portfolio2_Block', $block_options);
	}
	...
	function block($instance) {
		...
		<div class="portfolio-box portfolio-style2 triggerAnimation animated" data-animate="bounceIn">
			<div id="owl-demo-portfolio" class="owl-carousel owl-theme">
				<?php
					...
					$p=1; while($portfolio->have_posts()) : $portfolio->the_post();
					$item_classes = '';
						$item_skill = '';
				...
				<?php if($p%2==0 or $p == $portfolio->found_posts){ ?>
				</div>
				<?php } ?>
				<?php $p++; endwhile; ?>
