...
**/
class Container_Open_Block extends AQ_Block {
	...
	function __construct() {
		...
		//create the block
		parent::__construct('container_open_block', $block_options);
	}
	...
	/**** Block Outer Ouput ****/
 	...
 	function before_block($instance) {
 		...
 		if($effect!='None'){
			$class_ = ' triggerAnimation animated';
			$animate = 'data-animate="'.$effect.'"';
		}else{
			$class_ = '';
			$animate = '';
		}
 		echo '
			<div class="'.$class.'">
			<div class="container '.$class_.'" '.$animate.'>';
			if($title!=''){ ?>
			<div class="mdTitle">
