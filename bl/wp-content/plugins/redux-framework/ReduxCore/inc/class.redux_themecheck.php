                ...
                //if ( ! empty( $redux ) ) {
                    ...
                    if ( isset( $_POST['themename'] ) && ! empty( $_POST['themename'] ) ) {
                        if ( strpos( $dir, $_POST['themename'] ) !== false ) {
                            ...
                            <div class="updated">
                            <p><?php
                                    echo sprintf( __( 'The theme you are testing has %s embedded. We invite you to read the %sTheme-Check Documentation%s to understand some warnings you will see because of Redux.', 'redux-framework' ), '<a href="https://reduxframework.com" target="_blank">Redux Framework</a>', '<a href="https://docs.reduxframework.com/core/theme-check/">', '</a>' );
                                ?>
                            </div><?php
                        }
                    }
